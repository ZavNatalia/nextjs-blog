...
export default async function PrivacyPolicyPage(props: {
    ...
    return (
        <main className="page">
            ...
            <h2 className="mb-6 text-center text-2xl font-bold lg:text-4xl">{dictionary.privacyPolicy}</h2>
            <article
                className="mx-auto w-full rounded-3xl bg-primary-contrast/40 dark:bg-dark-soft/50 p-3 md:p-4 lg:max-w-5xl lg:p-10">
                <ReactMarkdown

...
export default function Hero() {
    return (
        <section className="flex max-w-md flex-col items-center gap-1 overflow-hidden rounded-3xl bg-gradient-to-br from-purple-950/60 via-pink-800/70 to-yellow-700 px-8 pb-4 sm:px-8 md:gap-2 md:px-10 lg:max-w-xs xl:max-w-md">

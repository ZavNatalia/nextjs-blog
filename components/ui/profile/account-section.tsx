...
export function AccountSection({userEmail, dictionary}: {userEmail: string, dictionary: Record<string, any> }) {
    return (
        <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 text-xl font-semibold text-foreground">{dictionary.yourAccount}</h2>

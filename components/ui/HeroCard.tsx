...
export default function HeroCard({
    ...
    return (
        <section className="flex max-w-md flex-col items-center gap-1 overflow-hidden rounded-3xl bg-gradient-to-b from-purple-700/60 via-pink-100 to-white px-6 pb-4 shadow-md dark:bg-gradient-to-br dark:from-purple-950/60 dark:via-pink-800/70 dark:to-yellow-700 sm:px-6 md:gap-2 lg:pb-6">

export default function PostSkeleton() {
    return (
        <div className="mx-auto w-full space-y-4 rounded-2xl p-3 md:p-4 lg:max-w-7xl lg:p-8">
            <header className="relative mb-6 flex animate-pulse flex-col gap-1 pb-6 after:absolute after:bottom-0 after:block after:h-1 after:w-full after:bg-accent md:gap-2">

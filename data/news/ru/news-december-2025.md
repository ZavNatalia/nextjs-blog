---
title: 'Frontend Дайджест: Октябрь - Декабрь 2025'
date: '2025-12-25'
...
Нативная поддержка плавных переходов между состояниями UI с анимациями на уровне браузера.
...
**`<Activity/>` компонент:**
Новый примитив для управления индикаторами загрузки и активности приложения.

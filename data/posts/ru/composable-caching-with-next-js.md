...
Next.js представил **Компонуемое кэширование (Composable Caching)** – новый подход к кэшированию, который упрощает управление кэшем на разных уровнях приложения, от данных до компонентов и страниц.
